...
export function CycleContext() {
    ...
    return (
      <div className="flex flex-col justify-center h-full p-6">
        <div className="space-y-6">
          <div>
            <div className="text-2xl font-serif font-semibold text-text-main mb-2">
          ...
          <div className="space-y-3 pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-text-main">Log Your Period</div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-text-main">Track Daily</div>
                <div className="text-xs text-sage-600 mt-0.5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-text-main">Get PCOS Insights</div>
                <div className="text-xs text-sage-600 mt-0.5">
  ...
  return (
    <div className="relative flex flex-col p-6 overflow-y-auto">
      <div className="flex justify-between items-start">
        <div className="flex-1">
          ...
          <div className="flex items-baseline gap-3 mb-2">
            ...
            {variability > 10 && (
              <span className="px-3 py-1 rounded-full bg-sage-50 text-xs text-sage-700 border border-sage-200 font-medium">
                Dynamic Pattern
              </span>
            )}
          </div>
          ...
          {analysis.cycleHistory.length > 1 && (
            <div className="mt-4 pt-4 border-t border-border">
              <div className="flex items-center gap-4 text-xs">
                <div>
                  <span className="text-sage-600">Recent Cycles:</span>{' '}
                ...
                {variability > 0 && (
                  <div>
                    <span className="text-sage-600">Variability:</span>{' '}
                    <span className={`font-medium ${variability > 10 ? 'text-sage-600' : 'text-primary'}`}>
          ...
          {isLongCycle ? (
            <div className="w-32 space-y-3">
              <div className="flex items-center justify-between text-xs">
                <span className="text-sage-600">Stability</span>
                <span className="text-sage-700 font-semibold">{metabolicScore}%</span>
              </div>

              <div className="relative h-3 bg-sage-100 rounded-full overflow-hidden">
                <div
                  className="absolute inset-y-0 left-0 bg-gradient-to-r from-primary to-sage-500 rounded-full transition-all duration-500"
              ...
              <div className="pt-3 mt-3 border-t border-border">
                <div className="text-[10px] text-sage-600 space-y-1">
                  <p>Focus Areas:</p>
                  <div className="flex flex-wrap gap-1 mt-1">
                    <span className="px-2 py-0.5 rounded bg-primary/20 text-primary">Sleep</span>
                    <span className="px-2 py-0.5 rounded bg-primary/20 text-primary">Nutrition</span>
                    <span className="px-2 py-0.5 rounded bg-primary/20 text-primary">Movement</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-32 h-32 relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <div className="text-xs text-sage-600">Tracking</div>
              </div>
            </div>
          )}
        </div>
