...
export const Navbar: React.FC<NavbarProps> = ({ onOpenSettings, onOpenClinicalGuide, onOpenEducation }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[60] w-full bg-gradient-to-r from-[#FDFBF7]/95 via-[#FFF8F5]/95 to-[#FFF0F0]/95 backdrop-blur-md border-b border-stone-100/50 shadow-sm transition-all duration-300">
